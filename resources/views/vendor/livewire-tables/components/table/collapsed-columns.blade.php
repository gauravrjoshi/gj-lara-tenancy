...
@if ($this->collapsingColumnsAreEnabled() && $this->hasCollapsedColumns())
    ...
    <tr
        ...
        $attributes->merge($customAttributes)
                ->class(['hidden bg-white   rappasoft-striped-row' => ($isTailwind && ($customAttributes['default'] ?? true) && $rowIndex % 2 === 0)])
                ->class(['hidden bg-gray-50   rappasoft-striped-row' => ($isTailwind && ($customAttributes['default'] ?? true) && $rowIndex % 2 !== 0)])
