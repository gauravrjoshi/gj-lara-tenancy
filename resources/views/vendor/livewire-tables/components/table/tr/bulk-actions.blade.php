                    ...
                    <button
                        ...
                        {{
                            $this->getBulkActionsRowButtonAttributesBag->class([
                                ...
                                'text-blue-600 text-gray-700 focus:text-gray-800  ' => $this->isTailwind && ($this->getBulkActionsRowButtonAttributes['default-colors'] ?? true),
